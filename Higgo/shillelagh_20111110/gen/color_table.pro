...
endif else plot_image,ctarr[1:*,*],yticklen=.001,ytickname=strarr(10)+' ',xtit=title,/noerase,charsize=1.4,position=thispos,origin=[thisoriginx,thisorigin],scale=thisscale,xticklen=1,xlog=log,color=255,thick=2,charthick=5;,xticks=2
