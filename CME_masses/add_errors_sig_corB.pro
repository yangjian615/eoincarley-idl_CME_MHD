function add_errors_sig_corB

cd,'/Users/eoincarley/Data/secchi_l1/20081212/COR1+COR2'
restore,'std_dev_mass_error_cor1b.sav',/verb
array1=std_dev_mass_error_cor1b
cd,'/Users/eoincarley/Data/secchi_l1/20081212/20081212_cor1/20081212_cor1b_B/total_brightness'
list=findfile('*.fts')
times1 = anytim(file2time(list[1:n_elements(list)-1]),/utim)

cd,'/Users/eoincarley/Data/secchi_l1/20081212/COR1+COR2'
restore,'std_dev_mass_error_cor2b.sav',/verb
array2=std_dev_mass_error_cor2b
cd,'/Users/eoincarley/Data/secchi_l1/20081212/20081212_cor2b/total_brightness'
list=findfile('*.fts')
