pro force_20081212_v2,proper_error=proper_error
...
position=[0.13, 0.75, 0.98, 0.98],/normal,/noerase,xtickname=[' ',' ',' ',' ',' ',' '],xticks=4,xminor=4,xr=[2,18],/xs,$
xtickv=[2,6,10,14,18]
...
/noerase,xtickname=[' ',' ',' ',' ',' ',' '],xticks=4,xminor=4,xr=[2,18],/xs,$
xtickv=[2,6,10,14,18]
oploterror,(mid_km[1:n_elements(mid_km)-2]*1000)/rsun,mid_accel[1:n_elements(mid_accel)-2],$
...
oplot,vfit[0,329:n_elements(vfit[0,*])-1],accel_fit[329:n_elements(vfit[0,*])-1],linestyle=0,color=40
...
;print,' '
restore,'velocity_fit_20081212.sav' ;made using velocity_fit_20081212.pro
oplot,vfit[0,*],kinE_fit[*]/1.0e30,linestyle=0,color=40
