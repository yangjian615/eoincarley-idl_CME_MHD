pro plot_cme_mass_20100301_v3, date, mask=mask, no_mask = no_mask, invert_mask = invert_mask,$
...
;**********   MASK APPLIED AS NORMAL   ************
	...
	set_line_color	   		  	   		  
	!p.multi=[0,1,1]
	utplot, t_c2, mass_c2/C, xr=[tstart, tend], yr=[-2.0, (max_mass + 0.5*max_mass)/C+0.5], $
	/xs, /ys, psym=1, ytitle='CME Mass x1e15 (g)' ,color=5
	;,$
	;position=[0.12, 0.68, 0.99, 0.99], xtickname=[' ',' ',' ',' ',' ', ' '],xtit=' '

	oplot, t_c2, mass_c2/C, color=5
	oplot, t_c3, mass_c3/C,psym=8, color=5
	oplot, t_c3, mass_c3/C, color=5
