pro plot_allcallisto_swaves_correction_2,array,freq_kHz,times,choose_points=choose_points,all_callisto=all_callisto
...
set_plot,'ps'
device, filename = '20110607_radio2_draft9.ps',/color,bits=8,/inches,/landscape
...
rectangle, x_rec, y_rec, 1200, 320.0*(MHz_convert), color=0, thick=3, linestyle=0
rectangle, x_rec, y_rec, 1200, 320.0*(MHz_convert), color=255, thick=3, linestyle=2
...
spectro_plot, spec_z_20110607 > (0.0) < 70, spec_x_20110607, spec_y_20110607,$
	/xs, xr=[a,b], xtitle=xtit, tick_unit=300, $
	/ys, yr=[20.0, 340.0], yticks=8.0, yminor=4, $
...
plots,[0.1,0.55],[0.54,.55],/normal,thick=3,linestyle=0,color=0;======[x1,x2],[y1,y2]=====
plots,[0.1,0.55],[0.54,.55],/normal,thick=3,linestyle=2,color=255

plots,[0.1,0.55],[0.665,1],/normal,thick=3,linestyle=0,color=0
plots,[0.1,0.55],[0.665,1],/normal,thick=3,linestyle=2,color=255

plots,[0.595,0.55],[0.90,.47],/normal,thick=3,linestyle=0,color=0;======[x1,x2],[y1,y2]====
plots,[0.595,0.55],[0.89,.47],/normal,thick=3,linestyle=2,color=255
plots,[0.645,1],[0.90,0.47],/normal,thick=3,linestyle=0,color=0;======[x1,x2],[y1,y2]=======
plots,[0.645,1],[0.90,0.47],/normal,thick=3,linestyle=2,color=255

cd,'/Users/eoincarley/Data/CALLISTO/20110607/Fits'
radio_spectro_fits_read,'BIR_20110607_062400_10.fit', z_zoom, x_zoom, y_zoom
z_zoom_1 = constbacksub(z_zoom,/auto)
...
spectro_plot, z_zoom_1 > (5.0) < 50, x_zoom, y_zoom, $
	/xs, xr=[a,b], xtitle=xtit, tick_unit=30, $
	ytitle='Frequency (MHz)', /ys, yr=[30,90], yminor=2, $
	position=[0.55,0.01,1,0.47], /normal, /NOERASE

;xyouts,0.805,0.898,'Frequency (MHz)',/normal,charsize=0.7,color=255,orientation=90.0, charthick=4
...
spectro_plot,smooth(bytscl(z_zoom,140,165),3),x_zoom,y_zoom,$
	/xs,xr=[a,b],xticks=1,xtickname=[' ',' ',' ',' ',' ',' ',' '],$
	/ys, yr=[30,90] ,yticks=1, ytickname=[' ',' '], charsize=0.5,$
	position=[0.86,0.85,0.99,0.99],/normal,/NOERASE, xtitle=' '
	;pos=[x0,y0,x1,y1], 
xyouts,0.56,0.44,'(c)',/normal,charsize=1.2,color=255	
	
axis,xaxis=0,xticklen=-0.05,xticks=2,xtickname=['06:25:50','06:26:10','06:26:30'], $
xtitle='Time in UT', charthick=3.0, charsize=0.8

axis,yaxis=0,yticklen=-0.05,yticks=2,ytickname=['90','60','30'],charsize=0.8,yminor=3, $
ytitle='Frequency (MHz)', charthick=3.0
