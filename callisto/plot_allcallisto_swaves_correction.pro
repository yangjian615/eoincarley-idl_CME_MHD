pro plot_allcallisto_swaves_correction,array,freq_kHz,times,choose_points=choose_points,all_callisto=all_callisto
...
set_plot,'ps'
device, filename = '20110607_radio2_draft6.ps',/color,bits=8,/inches,/landscape
...
times,hi_freq_MHz[0:n_elements(hi_freq_MHz)-2]*(MHz_convert),$;remove MHZ_convert to plot in MHz
	...
	YTICKS=nticks-1,YTICKV=Reverse(ticks),/ys,/ylog,ytitle='Frequency (Hz)',ytickname=['10!U7!N',' ',' ','10!U6!N',' ',' '],$
