...
plot,freq,ysun,color=1,xtickinterval=freqstep,yrange=yrange,charsize=1,xrange=[50,870]
legend,['AGC=60'],box=0,/top,/right,charsize=1.5
multiplot
ENDIF
if i eq 1 then begin
plot,freq,ysun,color=1,xtickinterval=freqstep,yrange=yrange,charsize=1,xrange=[50,870]
legend,['AGC=90'],box=0,/top,/right,charsize=1.5
multiplot
ENDIF
if i eq 2 then begin
plot,freq,ysun,color=1,xtickinterval=freqstep,yrange=yrange,charsize=1,xrange=[50,870]
legend,['AGC=100'],box=0,/top,/right,charsize=1.5
multiplot
ENDIF
if i eq 3 then begin
plot,freq,ysun,color=1,xtickinterval=freqstep,yrange=yrange,charsize=1,xrange=[50,870]
legend,['AGC=120'],box=0,/top,/right,charsize=1.5
multiplot
ENDIF
;loadct,5
