pro hough_typeII_20110607,angle1,angle2,light_curve_hough
...
plot_image,bytscl(congrid(result_n,800,500),0,0.7),xticks=1,xtickname=[' ',' '],xtitle='Theta (degrees)',$
...
save,normal_back,filename=$
'back_hough_typeII_'+string(angle1,format='(i03)')+'_'+string(angle2,format='(i03)')+'.sav'
times = x[x1:x2]
save,times,filename='times.sav'
freq=y[y1:y2]
save,freq,filename='freq.sav'
