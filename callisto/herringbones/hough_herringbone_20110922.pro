pro hough_herringbone_20110922,angle1,angle2,normal_back, PLOT_HOUGH=plot_hough
...
t2_index = closest(times,anytim(file2time('20110922_105230'),/utim))
...
oplot,set_time[*],intensity
	...
	peak_times=0.0
	FOR i=1, n_elements(set_time)-2 DO BEGIN
