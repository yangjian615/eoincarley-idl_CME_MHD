...
;These are the pre-event and object image used for COR1 Figure 4 of the Nat Phys draft
...
;These are the pre-event and object image used for C2 Figure 4 of the Nat Phys draft
...
; Again the values are tweaked to produce nice images by eye.
...
;---------------------------------------------;
;	One of my codes to get a mask for lasco
;---------------------------------------------;
...
function lasco_get_mask_v2, hdr, set_zero = set_zero
	...
	; Keyword
	;	-set_zero: return zeros at occulter positions. Default is NaNs.	
