pro nrh_source_position_20110922_v2, choose_points=choose_points, AIA_IMAGE=AIA_IMAGE, old_linear_fit=old_linear_fit
...
IF keyword_set(old_linear_fit) THEN BEGIN
	...
	;;-------------- Plotting the Fit ----------------
	oplot, times_in_ut[0]+time_sim, angle_sim - 170.0
